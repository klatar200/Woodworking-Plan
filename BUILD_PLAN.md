...
| Sprint 62 (Skip note / reachability) | 🔄 **OPEN** — delete unreachable colour gate or lower it; designer string reachability guard. |

Test suite — expected: 1182/1182 across 102 files (Sprint 61, Cursor VM; Sprint 62 in flight). Update this single figure each sprint close; 1174/1174 and earlier superseded.
