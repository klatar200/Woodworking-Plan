...
| Sprint 60 (Dimension display) | 🔄 **OPEN** — `formatInches` zero-numerator; unified fraction mismatch warning; harlequin thicknessIn=1. |

Test suite — expected: 1168/1168 across 100 files (Sprint 59, Cursor VM; Sprint 60 in flight). Update this single figure each sprint close; 1165/1165 and earlier superseded.
