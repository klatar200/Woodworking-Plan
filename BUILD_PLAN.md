...
| Sprint 66 (stream orphan + drag tests) | ✅ **CLOSED** 2026-07-26 — **98/100**. `$~`/`$RC` orphan characterised (not CSP); loading landmark mitigations; jsdom pointer-drag coverage. Suite **1259/1259**. Part C: no next §4 item without Keagan. |

Test suite — expected: 1259/1259 across 112 files (Sprint 66). Update this single figure each sprint close; 1251/1251 and earlier superseded.
