...
| Sprints 53–56 (Designer polish) | 🟡 Sprint **53 CLOSED** 2026-07-25 — **96/100** (`cff58b9` layout/chrome: full-width sticky preview, Preview+Export one line, diagram move labels, species nowrap); suite **1105/1105**. 54–56 still scheduled, unopened. U6/U7 still unopened; advanced templates + wider Canva-like set deferred. |
