...
| **54 — Desktop-only designer + mobile plan/cut list** | **1** | ✅ **CLOSED** 2026-07-26 — **96/100** (`4e8f2bf`). Viewport `lg` gate; form stays mounted; WebGL never created below `lg`; exact notices; print sheet screen-stack; HeaderSearch → `xl` (`a728a0e`). B7 held (no `toParts()`). |
